...
$user_id = $_SESSION['user_id'];$stmt = $pdo->prepare("SELECT * FROM quizzes WHERE id = ?");
...
<?php endforeach; ?>
                    ...
                    <?php else: ?>
<textarea name="q_<?= $q['id'] ?>" rows="3" class="answer-textarea" required placeholder="Votre réponse..."></textarea>
<?php endif; ?>
</div>
<?php endforeach; ?>
 
            <button type="submit" class="btn btn-submit">Envoyer mes réponses</button>
</form>
</div>
</body>
</html>